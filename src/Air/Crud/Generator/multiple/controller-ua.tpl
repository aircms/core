 ...
 *
 * @mod-header {"title": "Зображення", "by": "image", "type": "image"}
 ...
 * @mod-filter {"type": "select", "by": "status", "options":[{"value": "status-1", "title": "Перший статус"}, {"value": "status-2", "title": "Другий статус"}]}
